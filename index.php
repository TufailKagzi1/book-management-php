...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "INSERT INTO feedback(fname,femail,fmobile,fmsg) values('$fname', '$femail', '$fmobile', '$fmsg')";
...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Book Record</h1>
			<!-- Icon Divider-->
					...
					<form id="contactForm" action="index.php" method="post">
						...
						<div class="form-floating mb-3">
							<input class="form-control" id="email" type="email" name="email"
								placeholder="name@example.com" data-sb-validations="required,email" /> <label
								for="email">Email
								address</label>
						...
						<!-- Phone number input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="phone" type="tel" name="mobile" placeholder="(123) 456-7890"
